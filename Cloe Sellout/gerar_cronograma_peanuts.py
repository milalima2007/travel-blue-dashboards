...
SRC = os.path.join(BASE_DIR, "Cronograma Peanuts Cloe.xlsx")
OUTPUT = os.path.join(BASE_DIR, "cronograma-peanuts.html")
CSV_OUTPUT = os.path.join(BASE_DIR, "Cronograma_Peanuts_Cloe_EDITAR.csv")
...
<title>Cronograma Peanuts · Cloe</title>
<style>
...
<div class="header">
  <div class="logo">
    ...
    <div class="logo-text">
      ...
      <span class="sub">Cronograma · Peanuts Cloe</span>
    </div>
  </div>
